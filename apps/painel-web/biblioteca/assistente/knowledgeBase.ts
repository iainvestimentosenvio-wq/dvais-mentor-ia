...
export const ENTRIES: KBEntry[] = [
  {
    ...
    responses: [
      'O DVAi$ é um mentor inteligente para investimentos: você aprende enquanto analisa o mercado, com dados em tempo real, leitura técnica e camadas de proteção para tomar decisões com mais segurança.',
      'O DVAi$ te guia do básico ao avançado: explica o que você está vendo, organiza os sinais do mercado e te ajuda a decidir com método — sem promessas mágicas, com foco em técnica e segurança.',
      'Aqui você aprende fazendo. O DVAi$ combina visão didática + análise em tempo real + proteção inteligente para você sair do "achismo" e investir com mais clareza.',
    ],
    actions: [
  ...
  },
  {
    ...
    responses: [
      'Posso te guiar agora. Quer começar por: (1) Análise em tempo real, (2) Proteção inteligente, ou (3) Aprendizado contínuo?',
      ...
      'Eu consigo navegar com você aqui no site e destacar cada parte. Quer ver primeiro análise, segurança ou aprendizado?',
    ],
  ...
  },
  {
    ...
    responses: [
      'Na análise em tempo real você vê o mercado "de verdade": preço, candles, livro de ordens, profundidade, volume e indicadores técnicos — tudo para você ler contexto e risco com mais clareza.',
      'Essa área é onde você transforma dados em decisão: preço + candles + ordens + volume + indicadores. Eu te explico cada item e como interpretar sem chute.',
      'Aqui você acompanha os principais sinais do mercado em tempo real e aprende o que cada métrica significa para evitar decisões impulsivas.',
    ],
  ...
  },
  {
    ...
    responses: [
      ...
      'Oi! Posso te ajudar com análise em tempo real, proteção inteligente ou aprendizado contínuo. O que você quer saber?',
    ],
  },
  {
    ...
    responses: [
      'Não fazemos custódia de ativos, não pedimos senhas ou códigos de verificação, não prometemos lucro garantido e não somos uma corretora. Somos uma plataforma educacional que te ajuda a investir com mais segurança.',
      'Não guardamos seus ativos, não pedimos credenciais e não garantimos lucros. Somos uma ferramenta educacional para te ajudar a tomar decisões melhores.',
      'Não somos corretora, não fazemos custódia e não pedimos senhas. Nosso papel é te ensinar a analisar o mercado e investir com método e segurança.',
    ],
  },
  {
    id: 'sobre_ia',
      ...
      for (const bad of FORBIDDEN_TOPICS) {
        ...
        if (q.includes(normalizedBad) || normalizedBad.includes(q)) {
          const result: KBReplyRaw = {
            entryId: 'forbidden',
            responses: [
              'Consigo te ajudar com o DVAi$ e com as funções mostradas aqui no site. Me diga o que você quer entender: análise em tempo real, proteção inteligente ou aprendizado contínuo?',
            ],
            actions: [{ type: 'navigateRoute', route: '/' }],
          }
