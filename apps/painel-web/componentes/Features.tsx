...
export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: 'Segurança, gestão de risco, transparência e Guia Financeiro (opcional) para apoiar suas decisões.',
            ...
            const content = (
              <>
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  {/* Icon */}
                  <div className={`w-16 h-16 bg-gradient-to-br ${feature.iconGradient} rounded-xl flex items-center justify-center mb-6 mx-auto shadow-lg shadow-blue-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
