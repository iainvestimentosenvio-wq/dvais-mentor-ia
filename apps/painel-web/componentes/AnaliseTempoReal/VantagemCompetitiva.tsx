...
export default function VantagemCompetitiva() {
  const vantagens = [
    {
      icon: 'fas fa-rocket',
      title: 'Anos de Experiência em Segundos',
      description: 'O que leva anos para aprender com literatura, aqui você aprende na prática. Nosso sistema já fez o trabalho pesado de pesquisa, backtesting e otimização.',
      benefit: 'Economize anos de estudo',
      gradient: 'from-blue-500/20 to-cyan-600/20',
      iconGradient: 'from-blue-400 to-cyan-500'
    },
    {
      icon: 'fas fa-calculator',
      title: 'Calculamos Tudo Para Você',
      description: 'Análises complexas, cálculos de risco, tamanho de posição, volatilidade, sentimento de mercado... Tudo automatizado e em tempo real.',
      benefit: 'Não disperdice a sua capacidade em tarefas repetitivas',
    ...
    },
    {
      ...
      description: 'Chega de investir por emoção ou intuição. Cada decisão é respaldada por dados reais, análises técnicas e fundamentalistas, e modelos de IA.',
      benefit: 'Elimine a emoção dos seus trades',
    ...
    },
    {
      ...
      description: 'O mercado nunca para, e nós também não. Nossos modelos são atualizados continuamente com novos dados, notícias e eventos do mercado.',
      benefit: 'Nunca fique desatualizado',
    ...
    <section className="py-20 px-4 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Por que investidores inteligentes escolhem o DVAi$ - Mentor IA
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {vantagens.map((vantagem, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${vantagem.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              
              {/* Content */}
              <div className="relative z-10 space-y-4">
                {/* Ícone */}
                <div className={`w-16 h-16 bg-gradient-to-br ${vantagem.iconGradient} rounded-xl flex items-center justify-center shadow-xl shadow-blue-500/40 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 mb-4 glow-blue`}>
                  {vantagem.title === 'Anos de Experiência em Segundos' ? (
                    <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <ellipse cx="12" cy="7" rx="4.5" ry="4" fill="none" stroke="currentColor" strokeWidth="0.8" opacity="0.6"/>
                      {/* Areia no bulbo superior (apenas parte de cima, não toda) */}
                      <path d="M 7.5 3.8 Q 7.5 5 12 6.5 Q 16.5 5 16.5 3.8 Q 16.5 3.8 12 3.8 Q 7.5 3.8 7.5 3.8 Z" fill="currentColor" opacity="0.9"/>
                      <ellipse cx="12" cy="5.5" rx="3.5" ry="2.5" fill="currentColor" opacity="0.8"/>
                      {/* Gargalo estreito no centro */}
                      <rect x="11" y="10.5" width="2" height="1.5" fill="currentColor" opacity="0.6"/>
                      {/* Linha de areia descendo pelo funil */}
                      <line x1="12" y1="10.5" x2="12" y2="12" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity="0.9"/>
                      {/* Contorno do bulbo inferior */}
                      <ellipse cx="12" cy="15.5" rx="4.5" ry="4" fill="none" stroke="currentColor" strokeWidth="0.8" opacity="0.6"/>
                      {/* Areia no bulbo inferior (acumulando embaixo) */}
                      <ellipse cx="12" cy="17.5" rx="3.5" ry="2" fill="currentColor" opacity="0.7"/>
                      <path d="M 7.5 17.5 Q 7.5 18.5 12 19.2 Q 16.5 18.5 16.5 17.5 Q 16.5 17.5 12 17.5 Q 7.5 17.5 7.5 17.5 Z" fill="currentColor" opacity="0.8"/>
                      {/* Base inferior */}
                    ...
                    <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {/* Tela/Display */}
                      <rect x="6" y="5" width="12" height="4" rx="0.5" fill="currentColor" opacity="0.2"/>
                      {/* Linha na tela (simulando números) */}
                      <line x1="7" y1="7" x2="17" y2="7" stroke="currentColor" strokeWidth="0.8" opacity="0.6"/>
                    ...
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      ...
                      <path d="M 12 2 A 10 10 0 0 1 22 12 A 10 10 0 0 1 12 22 A 10 10 0 0 1 2 12" stroke="currentColor" fill="none"/>
                      {/* Seta na ponta superior - seta triangular grande e bem visível (apontando para direita, sentido horário) */}
                      <path d="M 12 2 L 18 0 L 16 6 Z" fill="currentColor" stroke="currentColor" strokeWidth="1"/>
                    </svg>
                  ) : (
      ...
      <div className="max-w-4xl mx-auto space-y-8 text-center mt-16">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Não somos apenas uma plataforma de análise. Somos seu <span className="text-cyan-400 font-bold">parceiro</span> na jornada de investimentos.
              <br />
