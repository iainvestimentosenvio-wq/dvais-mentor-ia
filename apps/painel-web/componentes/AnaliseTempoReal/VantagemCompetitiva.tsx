  ...
  const vantagens = [
    {
      ...
      description:
        'O que leva anos para aprender com literatura, aqui você aprende na prática. Nosso sistema já fez o trabalho pesado de pesquisa, backtesting e otimização.',
    ...
    },
    {
      ...
      description:
        'Análises complexas, cálculos de risco, tamanho de posição, volatilidade, sentimento de mercado... Tudo automatizado e em tempo real.',
    ...
    },
    {
      ...
      description:
        'Chega de investir por emoção ou intuição. Cada decisão é respaldada por dados reais, análises técnicas e fundamentalistas, e modelos de IA.',
    ...
    },
    {
      ...
      description:
        'O mercado nunca para, e nós também não. Nossos modelos são atualizados continuamente com novos dados, notícias e eventos do mercado.',
