  ...
  const publicos = [
    {
      ...
      description: 'Nunca investiu antes? Não tem problema. Nosso Mentor IA te guia passo a passo, ensinando desde os conceitos básicos até estratégias avançadas. Aprenda na prática, com exemplos reais e suporte contínuo.',
      benefits: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {publicos.map((publico, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${publico.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
              
              {/* Content */}
              <div className="relative z-10 space-y-6">
                {/* Ícone */}
                <div className={`w-16 h-16 bg-gradient-to-br ${publico.iconGradient} rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/30 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 glow-blue mx-auto`}>
                ...
                <ul className="space-y-3">
                  {publico.benefits.map((benefit, idx) => (
                    <li key={idx} className="flex items-start gap-3">
                      <Icon name="fas fa-check-circle" className="text-blue-400 mt-1 flex-shrink-0" />
