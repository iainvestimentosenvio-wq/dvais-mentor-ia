  ...
  const dados = [
    {
      ...
      description:
        'Valor atual do ativo no par de negociação (ex: BTC/USDT), variação percentual 24h, máxima e mínima do dia.',
    ...
    },
    {
      ...
      description:
        'Faremos de você um especialista na Leitura de Livro de Ordens, ou se preferir fazemos isto por você.',
    ...
    },
    {
      ...
      description:
        'Auxílio com análise de volume negociado em 24h e histórico em tempo real das últimas negociações (preço, quantidade, lado).',
    ...
    },
    {
      ...
      description:
        'Informações específicas de contratos futuros: funding rate, open interest, long/short ratio.',
