        ...
        <div className="text-center space-y-8">
          ...
          <p className="text-xl lg:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="text-blue-400 font-semibold">
              A Informação Instantânea é o Segredo do Sucesso.
            </span>
          </p>
          ...
          <div className="space-y-6 max-w-5xl mx-auto mt-12">
            ...
            <p className="text-lg text-gray-300 leading-relaxed text-center">
              ...
              foi desenvolvido para investidores{' '}
              <span className="text-cyan-400 font-semibold">iniciantes e experientes</span> que
              desejam se destacar no mercado de investimentos financeiros. Ensinamos você a analisar
              todos os dados fornecidos pelas principais corretoras, e muito mais.
            </p>
            <p className="text-lg text-gray-300 leading-relaxed text-center">
              <span className="text-xl lg:text-2xl font-bold text-white">Não apenas isso:</span>{' '}
              fornecemos análises e cálculos exclusivos para a sua realidade e momento atual do
              mercado, além de ajudar com dados já fornecidos pela sua plataforma podemos te
              entregar e ajudar em análise técnica em tempo real, coletando e calculando dados que a
              maioria das corretoras não te entrega, adicionamos um UP na sua vantagem competitiva,
              pensamos em seu investimento com respeito onde cada nanosegundo vale dinheiro.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
              ...
              >
                ...
                <svg
                  className="relative z-10 w-10 h-10 transform group-hover:translate-y-[-4px] transition-all duration-500 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                ...
                >
                  ...
                  <g className="group-hover:opacity-100 opacity-0 transition-opacity duration-300">
                    ...
                    <ellipse
                      ...
                      fill="#9ca3af"
                      opacity="0.8"
                      className="group-hover:animate-smoke-rise"
                    />
                    <ellipse
                      cx="10"
                      cy="20"
                      ...
                      fill="#6b7280"
                      opacity="0.7"
                      className="group-hover:animate-smoke-rise smoke-delay-1"
                    />
                    <ellipse
                      cx="12"
                      cy="20"
                      ...
                      fill="#4b5563"
                      opacity="0.7"
                      className="group-hover:animate-smoke-rise smoke-delay-2"
                    />
                    <ellipse
                      cx="14"
                      cy="20"
                      ...
                      fill="#6b7280"
                      opacity="0.7"
                      className="group-hover:animate-smoke-rise smoke-delay-3"
                    />
                    <ellipse
                      cx="16"
                      cy="20"
                      ...
                      fill="#9ca3af"
                      opacity="0.8"
                      className="group-hover:animate-smoke-rise smoke-delay-4"
                    />
                    <ellipse
                      cx="9"
                      cy="19"
                      ...
                      fill="#d1d5db"
                      opacity="0.6"
                      className="group-hover:animate-smoke-rise smoke-delay-5"
                    />
                    <ellipse
                      cx="11"
                      cy="19"
                      ...
                      fill="#e5e7eb"
                      opacity="0.6"
                      className="group-hover:animate-smoke-rise smoke-delay-6"
                    />
                    <ellipse
                      cx="13"
                      cy="19"
                      ...
                      fill="#e5e7eb"
                      opacity="0.6"
                      className="group-hover:animate-smoke-rise smoke-delay-7"
                    />
                    <ellipse
                      cx="15"
                      cy="19"
                      ...
                      fill="#d1d5db"
                      opacity="0.6"
                      className="group-hover:animate-smoke-rise smoke-delay-8"
                    />
                    <ellipse
                      cx="10.5"
                      cy="18"
                      ...
                      fill="#f3f4f6"
                      opacity="0.5"
                      className="group-hover:animate-smoke-rise smoke-delay-9"
                    />
                    <ellipse
                      cx="13.5"
                      cy="18"
                      ...
                      fill="#f3f4f6"
                      opacity="0.5"
                      className="group-hover:animate-smoke-rise smoke-delay-10"
                    />

                    {/* Chama intensa - MAIS fogo */}
                    <path
                      d="M8 20 Q9 16 10 20 Q11 14 12 20 Q13 14 14 20 Q15 16 16 20 Q12 13 12 20"
                      fill="#fbbf24"
                      opacity="1"
                      filter="url(#glow)"
                      className="group-hover:animate-fire-flicker"
                    />
                    <path
                      d="M9 20 Q10 17 11 20 Q12 15 13 20 Q14 17 15 20 Q12 14 12 20"
                      fill="#f59e0b"
                      opacity="0.95"
                      className="group-hover:animate-fire-flicker fire-delay-1"
                    />
                    <path
                      d="M9.5 20 Q10.5 18 11.5 20 Q12 16 12.5 20 Q13.5 18 14.5 20 Q12 15 12 20"
                      fill="#dc2626"
                      opacity="0.9"
                      className="group-hover:animate-fire-flicker fire-delay-2"
                    />
                    <path
                      d="M10 20 Q11 19 12 20 Q12 17 12 20"
                      fill="#ef4444"
                      opacity="0.85"
                      className="group-hover:animate-fire-flicker fire-delay-3"
                    />
                    <path
                      d="M11 20 Q12 19.5 13 20 Q12 17.5 12 20"
                      fill="#991b1b"
                      opacity="0.8"
                      className="group-hover:animate-fire-flicker fire-delay-4"
                    />
                  </g>
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 scale-0 group-hover:scale-100 transition-all duration-300 z-20 pointer-events-none">
                  <div className="relative">
                    ...
                    <div className="relative bg-blue-500/30 backdrop-blur-sm rounded-full p-4 border-2 border-blue-400/50 group-hover:border-blue-400 transition-all duration-300">
                      <Icon
                        name="fas fa-play"
                        className="text-3xl text-blue-300 transform translate-x-0.5 group-hover:scale-110 transition-transform duration-300"
                      />
                    </div>
                  </div>
                </div>
