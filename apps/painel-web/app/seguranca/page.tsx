...
export const metadata: Metadata = {
  ...
  description: 'Camadas de segurança, gestão de risco e transparência para proteger seus investimentos. Sistema avançado de proteção inteligente com alertas e orientação educacional.',
  keywords: ['proteção inteligente', 'segurança investimentos', 'gestão risco', 'transparência', 'alertas inteligentes', 'guia financeiro', 'orçamento inteligente'],
  alternates: {
    canonical: '/seguranca',
  },
  openGraph: {
    title: 'Proteção Inteligente | DVAi$ - Mentor IA',
    description: 'Camadas de segurança, gestão de risco e transparência para proteger seus investimentos.',
    type: 'website',
    url: '/seguranca',
  },
}
